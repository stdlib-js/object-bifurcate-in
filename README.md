...
```javascript
bifurcateIn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-bifurcate-in@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/object-bifurcate-in/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/object-bifurcate-in/actions/workflows/test.yml?query=branch:v0.1.1
